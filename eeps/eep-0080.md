...
A prototype has been used to validate the basic design, but the prototype is
not linked from this initial EEP draft.  A clean public implementation fork can
be linked once it is ready for review.
